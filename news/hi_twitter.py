...
# 第一步， 模拟发起请求
url = "https://twitter.com/search?vertical=news&q=lang%3Ahi&src=typd"
print(url)
...
spans = tree.xpath('//*[@id="stream-item-tweet-1169437245469839360"]/div/div[2]/div[2]/p')
print(type(spans),len(spans))
print(spans)
for span in spans:
    print(span.text)
